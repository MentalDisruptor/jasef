...
public class GenericOptions<T>{
    ...
    /**
     * Returns a new {@link Capabilities} object based on type parameter passed to this class.
    ...
    public T create() {
        try {
            ...
            log.error("While creating a new instance of {}, the underlying constructor threw an error.", typeArgumentClass.getName());
            ...
            log.error("The constructor required to create a new instance of {} is inaccessible.", typeArgumentClass.getName());
